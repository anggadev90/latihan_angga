...
import '../view/dahsboard2_view.dart';

class Dahsboard2Controller extends State<Dahsboard2View> {
  static late Dahsboard2Controller instance;
  late Dahsboard2View view;
