...
import '../view/dashboard9_view.dart';

class Dashboard9Controller extends State<Dashboard9View> {
  static late Dashboard9Controller instance;
  late Dashboard9View view;
