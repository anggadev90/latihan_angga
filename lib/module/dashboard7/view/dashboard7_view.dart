...
import '../controller/dashboard7_controller.dart';

class Dashboard7View extends StatefulWidget {
  Dashboard7View({Key? key}) : super(key: key);

  Widget build(context, Dashboard7Controller controller) {
  ...
  @override
  State<Dashboard7View> createState() => Dashboard7Controller();
}
